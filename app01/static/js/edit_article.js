...
function modifyCategory(){
        var category2Id = document.getElementById('dropdown-container');
        if (category2Id.style.display === "none" || category2Id.style.display === "") {
        category2Id.style.display = "flex";
        } else {
            category2Id.style.display = "none";
        }
